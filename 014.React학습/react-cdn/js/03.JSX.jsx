...
// (2) JSX를 사용하지 않는 방법 /////////////
// 넣을 요소를 createElement() 메서드로 생성해야함!(JSX 쓰지않고....)
const myele2 = 
...
const mydata = [
    ...
    {idx:3, name:"김헤수",movie:"내가쎈언니야"},
];

// map(value,index,array)을 사용한 태그생성하기
// map(배열값,순번,배열객체전체자신)
// 파라미터 구성은 forEach() 메서드와 유사함! 밑의 방식처럼 쓸 수 있음!
// const mylist = mydata.map((val,idx,obj)=>
//     <li>{val.name}:{val.movie} ★ {val.idx==3 ? "예뻐" : "멋쪄!"}</li>
// );
