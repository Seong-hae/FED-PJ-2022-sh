...
function EventShow(){
    ...
    const aladin = (lamp) => {  // lamp - 알라딘 주인공 이미지경로!
        console.log("aladin 함수:",lamp);
        // 1. #wrap 인 요소의 내부에 h1요소 넣기
    ...
    return(
        <React.Fragment>
            ...
            <button onClick={()=>{
                getIt2("https://www.pngplay.com/wp-content/uploads/13/Ferrari-458-Transparent-PNG.png");}}>소원빌기~!!! 페라리주세요~!!!</button>
