...
/******************************************************************
    ...
    3. 설치 :
        ...
        -> 설치 후 import로 사용할 페이지에 패키지를 포함시킨다!
        ...
        참고) router 변수와 옵션 routes 변수는 변경불가하다!!!
    ...
    5. 내장 컴포넌트
        (1) <router-view> : 라우트와 일치하는 컴포넌트를 랜더링 함
...
// $route는 현재 연결된 라우트 정보객체
// params 파라미터 전달 속성
// cls -> 내가 만든 파라미터 전달속성변수
...
const router = new VueRouter({
        ...
        // 두번째 루트의 파라미터 버전 루트추가!
        {
            ...
            // 호출과 구분하기 위해 반드시 name속성을 설정해야한다!
            name: "umsik",
            path: '/foods:item',
            // 경로뒤에 콜론(:)을 쓰고 뒤에 파라미터 변수를 써준다!
            component: Foods,
        }
    ],
});
