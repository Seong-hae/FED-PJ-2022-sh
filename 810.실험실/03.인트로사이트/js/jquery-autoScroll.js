...
/**************************************************** 
    ...
    -> 일반적으로 let, const 를 모두 변경할 필요는 없고
    내가 인스턴스 생성시 접근해야할 변수만 this로 등록한다!
    ...
    생성자함수 자신! 여기서는 AutoScroll 생성자 함수를 말한다!
    -> 할당형 함수 내부의 this키워드는 생성자함수 자신을 말함
    -> 이벤트에 속한 함수일 경우 이벤트 대상인 나 자신(this)은
