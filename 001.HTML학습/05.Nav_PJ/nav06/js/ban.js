...
/*******************************************************
    ...
    -> 전달값을 사용하여 개별적인 배너요소 하위의 기능으로
    작동하도록 최상위 배열요소를 함수로
    전달하여 내부 기능셋팅시 document로 선택했던 요소를
    모두 개별 최상위 배너요소 하위요소 선택으로 변경하면
    기존 변수셋팅을 그대로 사용하여 개별 배너 모듈화를
    손쉽게 할 수 있다!
...
// 배너 세팅 함수 //////////////////////////////
function setBan(obj,seq){ // obj는 최상위 요소 객체!, seq- 요소순번
    // 1.호출 확인
    // console.log("배너야~!");
